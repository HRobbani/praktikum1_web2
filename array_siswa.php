...
$list1 = ['nama' => 'Huda Robbani', 'matkul' => 'Pemrograman Web', 'nilai_uts' => 70, 'nilai_uas' => 75, 'nilai_tugas' => 50];
  ...
  <div class="row">
    ...
    <div class="col-md-12 d-flex justify-content-center px-5">
      <div class="card mb-3  w-100">
        <div class="card-header text-center text-white bg-success ">Daftar Nilai Siswa</div>
        <div class="card-body">
          <table class="table">
